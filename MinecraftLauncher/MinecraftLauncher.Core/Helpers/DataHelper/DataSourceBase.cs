...
namespace MinecraftLauncher.Core.Helpers.DataHelper
{
    public delegate void OnDataRequestError(int code);

    /// <summary>
    /// Datasource base for UMCL that enabled incremental loading (page based). <br/>
    ...
    public abstract class DataSourceBase<T> : IncrementalLoadingBase<T>
    {
        ...
        /// <summary>
        /// Special for UMCL, as their items are paged.
        /// </summary>
